...
rep={}
LINE=("J23","G3d","B4d","G13d","G13e","H16c","J17c","J19f","J5g","J1c","J2c")
# ---- 라인
...
for cfg in ("상승","하강"):
    ...
    for n,c in line:
        base=n.split("/")[-1]
        if base.startswith(("J17c","J19f","J5g","B4d","G3d","H16c","G13e")): g[base]=gl(box(c))
    for n,c in out:
        base=n.split("/")[-1]
...
json.dump(rep,open(os.path.join(VER,"check_hose50_0914.json"),"w",encoding="utf-8"),ensure_ascii=False,indent=1,default=str)
