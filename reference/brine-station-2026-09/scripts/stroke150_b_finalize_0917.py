...
PARTS=["J1c_fixed_plate_185x580_t10","J5l_moving_plate_180x540_t8","B9j_TiMOTION_TA2-2H-150274-5511-010-1","B10b_linear_bushing_MISUMI_LHFRW20_catalog","J23d_shaft_support_MISUMI_SHFSS20_catalog",
       "J2d_guide_shaft_MISUMI_PSSFAQ20-580-B13_catalog","J19k_hose_YASUNG_HSPF-032_up_U190_R40","J19k_hose_YASUNG_HSPF-032_dn_bow_R59"]
orph={}
for n in PARTS:
...
json.dump(rep,open(os.path.join(DESK,"_검증","stroke150b_finalize_0917.json"),"w",encoding="utf-8"),ensure_ascii=False,indent=1,default=str)
