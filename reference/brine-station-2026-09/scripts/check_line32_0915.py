...
rep={}
LINE=("B9g","J23c","K6_","J8e","J9f","G11f","J11e","G3e","B4e","G13f","G13g","H16d","J19i","J5k","J1c","J2c","B10")
# ---- 라인
...
for cfg in ("상승","하강"):
    ...
    for n,c in line:
        base=n.split("/")[-1]
        if base.startswith(("G13f","J19i","J5k","B9g","B4e","G3e","H16d","G13g","J9f")): g[base]=gl(box(c))
    for n,c in out:
        base=n.split("/")[-1]
...
json.dump(rep,open(os.path.join(VER,"check_line32_0915.json"),"w",encoding="utf-8"),ensure_ascii=False,indent=1,default=str)
