...
rep={}
LINE=("B9g","J23","J8e","J9d","G11f","J11e","G3d","B4d","G13d","N1_","E50","H16c","P1_","P2_","J19g","J5h","J1c","J2c","B10")
# ---- 라인
...
for cfg in ("상승","하강"):
    ...
    for n,c in line:
        base=n.split("/")[-1]
        if base.startswith(("P2_","P1_","E50","J19g","J5h","B9g","B4d","H16c")): g[base]=gl(box(c))
    for n,c in out:
        base=n.split("/")[-1]
...
json.dump(rep,open(os.path.join(VER,"check_loop50_0914.json"),"w",encoding="utf-8"),ensure_ascii=False,indent=1,default=str)
